...
document.addEventListener("DOMContentLoaded", function() {
  class Memory {
    constructor(
      ...
      this.matches = 0;
      this.fields = [
        ...this.mainElement.getElementsByClassName("memory__field")
      ];
    ...
    checkMatch = () => {
      let match = false;
      const clickedFields = [
        ...document.getElementsByClassName(this.clickedClassName)
      ];
    ...
    checkWin = () => {
      if (this.matches == this.fields.length / 2) {
        ...
        setTimeout(() => {
          ...
          link.href =
            "mailto:?subject=Memory%20game%20on%20CodePen&body=" +
            bodyString +
            "%20https://codepen.io/adabs-urdum/pen/bGdbYYa";
        }, 1000);
      }
    };
  }
